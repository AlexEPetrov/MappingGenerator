...
{
    public class ExternalMappingClassCodeAction : CodeAction
    {
        ...
        public ExternalMappingClassCodeAction(Document document, ClassDeclarationSyntax classDeclaration, string mappingSourceClass)
        {
        ...
        {
            return "Mapping: Create external mapper";
        }
